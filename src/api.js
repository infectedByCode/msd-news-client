...
export const getArticles = async (topic, sort_by, order, author, limit, p) => {
  const { data } = await axios.get(`${baseUrl}/articles`, { params: { topic, sort_by, order, author, limit, p } })
  const { articles, article_count } = data
